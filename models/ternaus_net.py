...
class TernausNet11(nn.Module):
    def __init__(self, num_classes, num_filters: int = 32, pretrained: bool = False) -> None:
        """
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        #if x.shape[-2] and x.shape[-1] are not multiples of 16, the model will throw an error
...
if __name__ == "__main__":
    model = TernausNet11(num_classes=14, num_filters=32, pretrained=False)
